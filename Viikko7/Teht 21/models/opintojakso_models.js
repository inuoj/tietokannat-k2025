...
const opintojakso = {
  ...
  update: function(id, opintojakso, callback) {
    return db.query(
      'update opintojakso set Koodi=?,Laajuus=?,Nimi=?, idOpintojakso=? where idOpintojakso=?',
      [opintojakso.Koodi, opintojakso.Laajuus, opintojakso.Nimi, opintojakso.idOpintojakso, id],
      callback
    );
  }
};
